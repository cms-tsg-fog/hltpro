...
./hltConfigFromDB --v2 --gdr --configName $menu > hlt.py
...
python ./onlineConverterHilton.py hlt.py hltConverted.py
...
bash ./L1MenuCheck_FromGT.sh /opt/hltd/python/HiltonMenu.py $gtag
